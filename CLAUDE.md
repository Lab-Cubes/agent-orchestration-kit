...
**What this is:** Reference implementation of NPS (Neural Protocol Suite), centred on **NOP (NPS-5, Neural Orchestration Protocol)** — a file-based mailbox protocol for multi-agent task dispatch. The protocol is runtime-agnostic; this kit wraps the Claude Code CLI as the agent runtime.
